 ...
 *
 */
public abstract class AbstractUpdatePEConfigurationOperation extends Operation {
     ...
     */
    public AbstractUpdatePEConfigurationOperation(String xml) throws OperationInitializationException {
        super(xml);
    }
