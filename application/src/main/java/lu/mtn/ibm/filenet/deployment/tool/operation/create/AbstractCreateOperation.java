 ...
 *
 */
package lu.mtn.ibm.filenet.deployment.tool.operation.create;
 ...
 *
 */
public abstract class AbstractCreateOperation extends Operation {
     ...
     */
    public AbstractCreateOperation(String xml) throws OperationInitializationException {
        super(xml);
    }
